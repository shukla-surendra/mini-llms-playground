...
[the project's full documentation](https://github.com/shukla-surendra/mini-llms-playground/tree/main/from_scratch/tinystories-gpt-6m)
...
repo_id = 'YOUR-USERNAME/tinystories-gpt-6m'  # replace with the actual repo you download from
ckpt_path = hf_hub_download(repo_id, 'tinystories_gpt_checkpoint.pt')
...
use `inference.py` / `api_server.py` directly, which handle sampling (temperature/top-k/
top-p/repetition-penalty), not just greedy decoding.
...
[source repository's docs](https://github.com/shukla-surendra/mini-llms-playground/tree/main/from_scratch/tinystories-gpt-6m/docs).
